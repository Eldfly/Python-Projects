...
"""
from products_inventory import Product, Inventory
...
flour = Product('Flour', 18.50, 20)


#create a new inventory and add my products
inventory = Inventory([milk,butter,cheese,egg])

#Add a singel product to the inventory
inventory.add_products(flour)

#remove a product from the inventory
inventory.remove_product(flour)
